...
exports.URDFCollider = exports.URDFVisual = exports.URDFMimicJoint = exports.URDFJoint = exports.URDFLink = exports.URDFRobot = void 0;
const three_1 = require("three");
const enable3d_1 = require("enable3d");
const _tempAxis = new three_1.Vector3();
const _tempEuler = new three_1.Euler();
const _tempTransform = new three_1.Matrix4();
const _tempOrigTransform = new three_1.Matrix4();
const _tempQuat = new three_1.Quaternion();
const _tempScale = new three_1.Vector3(1.0, 1.0, 1.0);
const _tempPosition = new three_1.Vector3();
class URDFBase extends enable3d_1.ExtendedObject3D {
    constructor(...args) {
        // @ts-expect-error
        super(...args);
        this.urdfNode = null;
...
class URDFJoint extends URDFBase {
    constructor(...args) {
        ...
        this.axis = new three_1.Vector3(1, 0, 0);
    ...
    set jointType(v) {
        ...
        switch (v) {
            ...
            case 'planar':
                ...
                this.axis = new three_1.Vector3(0, 0, 1);
                break;
            case 'floating':
