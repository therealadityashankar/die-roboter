...
})({"hrbMm":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "7f03983406768583";
"use strict";
...
},{}],"cbaU3":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Chunker", ()=>Chunker);
parcelHelpers.export(exports, "compute_file_hash", ()=>compute_file_hash);
parcelHelpers.export(exports, "compute_hmac", ()=>compute_hmac);
parcelHelpers.export(exports, "compute_verification_hash", ()=>compute_verification_hash);
parcelHelpers.export(exports, "compute_xorb_hash", ()=>compute_xorb_hash);
...
(0, _chunkQXAXOUZSMjs.__export)(chunker_wasm_bg_exports, {
    Chunker: ()=>Chunker,
...
var ChunkerFinalization = typeof FinalizationRegistry === "undefined" ? {
    register: ()=>{},
    unregister: ()=>{}
...
for(let i = 0; i < wasmBase64.length; i++)wasmBinary[i] = wasmBase64.charCodeAt(i);
...
async function init() {
    ...
    try {
        ...
        const wasm2 = await WebAssembly.instantiate(wasmModule, {
            "./hf_xet_thin_wasm_bg.js": Object.fromEntries(// @ts-expect-error ok for any type
            imports[0].names.map((name)=>[
                    name,
                    chunker_wasm_bg_exports[name]
                ]))
        });
...
},{"./chunk-QXAXOUZS.mjs":"2PklB","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["hrbMm"], null, "parcelRequire13ff", {})

//# sourceMappingURL=chunker_wasm-3YGRTTMN.06768583.js.map
