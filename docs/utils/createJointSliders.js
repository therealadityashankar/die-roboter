...
exports.createJointSliders = createJointSliders;
function createJointSliders(robot, containerId = 'joint-sliders', defaultValues) {
    ...
    Object.entries(robot.pivotMap).forEach(([key, pivot]) => {
        if (!pivot.physicsRepresentation)
            return;
...
exports.default = createJointSliders;
