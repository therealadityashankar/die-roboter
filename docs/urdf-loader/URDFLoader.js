...
exports.URDFMimicJoint = exports.URDFVisual = exports.URDFCollider = exports.URDFLink = exports.URDFJoint = exports.URDFRobot = void 0;
...
Object.defineProperty(exports, "URDFRobot", { enumerable: true, get: function () { return URDFClasses_1.URDFRobot; } });
Object.defineProperty(exports, "URDFJoint", { enumerable: true, get: function () { return URDFClasses_1.URDFJoint; } });
Object.defineProperty(exports, "URDFLink", { enumerable: true, get: function () { return URDFClasses_1.URDFLink; } });
Object.defineProperty(exports, "URDFCollider", { enumerable: true, get: function () { return URDFClasses_1.URDFCollider; } });
Object.defineProperty(exports, "URDFVisual", { enumerable: true, get: function () { return URDFClasses_1.URDFVisual; } });
Object.defineProperty(exports, "URDFMimicJoint", { enumerable: true, get: function () { return URDFClasses_1.URDFMimicJoint; } });
/*
...
class URDFLoader {
    constructor(enable3dPhysicsObject, manager) {
        ...
        this.workingPath = '';
        this.fetchOptions = {};
        this.enable3dObj = enable3dPhysicsObject;
    }
    /* Public API */
    loadAsync(urdf) {
    ...
    parse(content, workingPath = this.workingPath) {
        ...
        function processRobot(robot) {
            ...
            const obj = new URDFClasses_1.URDFRobot();
            ...
            jointList.forEach(j => {
                if (j instanceof URDFClasses_1.URDFMimicJoint) {
        ...
        function processJoint(joint) {
            ...
            if (mimicTag) {
                obj = new URDFClasses_1.URDFMimicJoint();
                ...
                obj = new URDFClasses_1.URDFJoint();
            }
            obj.urdfNode = joint;
        ...
        function processLink(link, visualMap, colliderMap, target = null) {
            if (target === null) {
                target = new URDFClasses_1.URDFLink();
            }
        ...
        function processLinkElement(vn, materialMap = {}) {
            ...
            const group = isCollisionNode ? new URDFClasses_1.URDFCollider() : new URDFClasses_1.URDFVisual();
            group.urdfNode = vn;
            children.forEach(n => {
                const type = n.nodeName.toLowerCase();
                if (type === 'geometry') {
    ...
    defaultMeshLoader(path, manager, done) {
        if (/\.stl$/i.test(path)) {
            const loader = new STLLoader_1.STLLoader(manager);
